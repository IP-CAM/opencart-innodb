-- -----------------------------------------------------
-- Version 0.1 (2012)
-- Author: Eugene Kuligin by OpenCart Ukrainian Team
-- Details: www.opencart-ua.org
-- File Encoding: UTF-8
-- -----------------------------------------------------
...
CREATE SCHEMA IF NOT EXISTS `OpenCart_InnoDB` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `OpenCart_InnoDB` ;

-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`customer_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`customer_group` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`store`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`store` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`customer`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`customer` (
  ...
  CONSTRAINT `fk_customer_customer_group1`
    ...
    REFERENCES `OpenCart_InnoDB`.`customer_group` (`customer_group_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_customer_store`
    FOREIGN KEY (`store_id` )
    REFERENCES `OpenCart_InnoDB`.`store` (`store_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`country`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`country` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`zone`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`zone` (
  ...
  CONSTRAINT `fk_zone_country`
    ...
    REFERENCES `OpenCart_InnoDB`.`country` (`country_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`address`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`address` (
  ...
  CONSTRAINT `fk_address_customer1`
    ...
    REFERENCES `OpenCart_InnoDB`.`customer` (`customer_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_address_zone1`
    FOREIGN KEY (`zone_id` )
    REFERENCES `OpenCart_InnoDB`.`zone` (`zone_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`affiliate`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`affiliate` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`language`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`language` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order_status`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order_status` (
  ...
  CONSTRAINT `fk_order_status_language`
    ...
    REFERENCES `OpenCart_InnoDB`.`language` (`language_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`currency`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`currency` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order` (
  ...
  CONSTRAINT `fk_order_order_status`
    ...
    REFERENCES `OpenCart_InnoDB`.`order_status` (`order_status_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_order_affiliate`
    FOREIGN KEY (`affiliate_id` )
    REFERENCES `OpenCart_InnoDB`.`affiliate` (`affiliate_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_order_currency`
    ...
    REFERENCES `OpenCart_InnoDB`.`currency` (`currency_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`affiliate_transaction`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`affiliate_transaction` (
  ...
  CONSTRAINT `fk_affiliate_transaction_order`
    ...
    REFERENCES `OpenCart_InnoDB`.`order` (`order_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`attribute_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`attribute_group` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`attribute`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`attribute` (
  ...
  CONSTRAINT `fk_attribute_attribute_group`
    ...
    REFERENCES `OpenCart_InnoDB`.`attribute_group` (`attribute_group_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`attribute_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`attribute_description` (
  ...
  CONSTRAINT `fk_attribute_description_attribute`
    ...
    REFERENCES `OpenCart_InnoDB`.`attribute` (`attribute_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`attribute_group_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`attribute_group_description` (
  `attribute_group_id` INT(11) NOT NULL ,
  `language_id` INT(11) NOT NULL ,
  `name` VARCHAR(64) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`banner`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`banner` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`banner_image`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`banner_image` (
  ...
  CONSTRAINT `fk_banner_image_banner`
    ...
    REFERENCES `OpenCart_InnoDB`.`banner` (`banner_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`banner_image_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`banner_image_description` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`category`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`category` (
  ...
  CONSTRAINT `fk_category_category`
    ...
    REFERENCES `OpenCart_InnoDB`.`category` (`category_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`category_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`category_description` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`layout`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`layout` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`category_to_layout`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`category_to_layout` (
  `category_id` INT(11) NOT NULL ,
  ...
  CONSTRAINT `fk_category_to_layout_layout`
    ...
    REFERENCES `OpenCart_InnoDB`.`layout` (`layout_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`category_to_store`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`category_to_store` (
  `category_id` INT(11) NOT NULL ,
  `store_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`coupon`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`coupon` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`coupon_history`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`coupon_history` (
  ...
  CONSTRAINT `fk_coupon_history_coupon`
    ...
    REFERENCES `OpenCart_InnoDB`.`coupon` (`coupon_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`manufacturer`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`manufacturer` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`stock_status`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`stock_status` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`tax_class`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`tax_class` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`length_class`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`length_class` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`weight_class`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`weight_class` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product` (
  ...
  CONSTRAINT `fk_product_manufacturer`
    ...
    REFERENCES `OpenCart_InnoDB`.`manufacturer` (`manufacturer_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_product_stock_status`
    FOREIGN KEY (`stock_status_id` )
    REFERENCES `OpenCart_InnoDB`.`stock_status` (`stock_status_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_product_tax_class`
    FOREIGN KEY (`tax_class_id` )
    REFERENCES `OpenCart_InnoDB`.`tax_class` (`tax_class_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_product_length_class`
    FOREIGN KEY (`length_class_id` )
    REFERENCES `OpenCart_InnoDB`.`length_class` (`length_class_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_product_weight_class`
    FOREIGN KEY (`weight_class_id` )
    REFERENCES `OpenCart_InnoDB`.`weight_class` (`weight_class_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`coupon_product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`coupon_product` (
  ...
  CONSTRAINT `fk_coupon_product_product`
    ...
    REFERENCES `OpenCart_InnoDB`.`product` (`product_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`customer_ip`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`customer_ip` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`customer_reward`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`customer_reward` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`customer_transaction`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`customer_transaction` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`download`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`download` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`download_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`download_description` (
  ...
  CONSTRAINT `fk_download_description_download`
    ...
    REFERENCES `OpenCart_InnoDB`.`download` (`download_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`extension`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`extension` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`geo_zone`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`geo_zone` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`information`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`information` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`information_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`information_description` (
  ...
  CONSTRAINT `fk_information_description_information`
    ...
    REFERENCES `OpenCart_InnoDB`.`information` (`information_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`information_to_layout`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`information_to_layout` (
  `information_id` INT(11) NOT NULL ,
  `store_id` INT(11) NOT NULL ,
  `layout_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`information_to_store`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`information_to_store` (
  `information_id` INT(11) NOT NULL ,
  `store_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`layout_route`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`layout_route` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`length_class_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`length_class_description` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`manufacturer_to_store`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`manufacturer_to_store` (
  `manufacturer_id` INT(11) NOT NULL ,
  `store_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`option`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`option` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`option_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`option_description` (
  ...
  CONSTRAINT `fk_option_description_option`
    ...
    REFERENCES `OpenCart_InnoDB`.`option` (`option_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`option_value`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`option_value` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`option_value_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`option_value_description` (
  ...
  CONSTRAINT `fk_option_value_description_option_value`
    ...
    REFERENCES `OpenCart_InnoDB`.`option_value` (`option_value_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order_product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order_product` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order_download`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order_download` (
  ...
  CONSTRAINT `fk_order_download_order_product`
    ...
    REFERENCES `OpenCart_InnoDB`.`order_product` (`order_product_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order_history`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order_history` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_option`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_option` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_option_value`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_option_value` (
  ...
  CONSTRAINT `fk_product_option_value_product_option`
    ...
    REFERENCES `OpenCart_InnoDB`.`product_option` (`product_option_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order_option`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order_option` (
  ...
  CONSTRAINT `fk_order_option_product_option_value`
    ...
    REFERENCES `OpenCart_InnoDB`.`product_option_value` (`product_option_value_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`order_total`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`order_total` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_attribute`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_attribute` (
  `language_id` INT(11) NOT NULL ,
  `product_id` INT(11) NOT NULL ,
  `attribute_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_description` (
  `product_id` INT(11) NOT NULL ,
  `language_id` INT(11) NOT NULL ,
  `name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `description` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_discount`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_discount` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_image`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_image` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_related`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_related` (
  `product_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_reward`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_reward` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_special`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_special` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_tag`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_tag` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_to_category`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_to_category` (
  `product_id` INT(11) NOT NULL ,
  `category_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_to_download`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_to_download` (
  `product_id` INT(11) NOT NULL ,
  `download_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_to_layout`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_to_layout` (
  `product_id` INT(11) NOT NULL ,
  `layout_id` INT(11) NOT NULL ,
  `store_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`product_to_store`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`product_to_store` (
  `product_id` INT(11) NOT NULL ,
  `store_id` INT(11) NOT NULL DEFAULT '0' ,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`return_status`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`return_status` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`return`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`return` (
  ...
  CONSTRAINT `fk_return_return_status`
    ...
    REFERENCES `OpenCart_InnoDB`.`return_status` (`return_status_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`return_action`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`return_action` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`return_history`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`return_history` (
  ...
  CONSTRAINT `fk_return_history_return`
    ...
    REFERENCES `OpenCart_InnoDB`.`return` (`return_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`return_reason`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`return_reason` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`return_product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`return_product` (
  ...
  CONSTRAINT `fk_return_product_return_reason`
    ...
    REFERENCES `OpenCart_InnoDB`.`return_reason` (`return_reason_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_return_product_return_action`
    FOREIGN KEY (`return_action_id` )
    REFERENCES `OpenCart_InnoDB`.`return_action` (`return_action_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`review`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`review` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`setting`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`setting` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`tax_rate`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`tax_rate` (
  ...
  CONSTRAINT `fk_tax_rate_geo_zone`
    ...
    REFERENCES `OpenCart_InnoDB`.`geo_zone` (`geo_zone_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`tax_rate_to_customer_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`tax_rate_to_customer_group` (
  ...
  CONSTRAINT `fk_tax_rate_to_customer_group_tax_rate`
    ...
    REFERENCES `OpenCart_InnoDB`.`tax_rate` (`tax_rate_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`tax_rule`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`tax_rule` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`url_alias`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`url_alias` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`user_group`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`user_group` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`user`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`user` (
  ...
  CONSTRAINT `fk_user_user_group`
    ...
    REFERENCES `OpenCart_InnoDB`.`user_group` (`user_group_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`voucher`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`voucher` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`voucher_history`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`voucher_history` (
  ...
  CONSTRAINT `fk_voucher_history_voucher`
    ...
    REFERENCES `OpenCart_InnoDB`.`voucher` (`voucher_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`voucher_theme`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`voucher_theme` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`voucher_theme_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`voucher_theme_description` (
  `voucher_theme_id` INT(11) NOT NULL ,
  `language_id` INT(11) NOT NULL ,
  `name` VARCHAR(32) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  ...
  CONSTRAINT `fk_voucher_theme_description_voucher_theme`
    ...
    REFERENCES `OpenCart_InnoDB`.`voucher_theme` (`voucher_theme_id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`weight_class_description`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`weight_class_description` (
...
-- -----------------------------------------------------
-- Table `OpenCart_InnoDB`.`zone_to_geo_zone`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `OpenCart_InnoDB`.`zone_to_geo_zone` (
