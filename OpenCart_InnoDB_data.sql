...
-- Script date 06/08/2012 02:27:30 a.m.
...
--
-- Table testopencart.oc_address does not contain any data (it is empty)

-- 
-- Dumping data for table oc_affiliate
--
-- Table testopencart.oc_affiliate does not contain any data (it is empty)

-- 
-- Dumping data for table oc_affiliate_transaction
--
-- Table testopencart.oc_affiliate_transaction does not contain any data (it is empty)
...
--
INSERT INTO oc_banner_image_description VALUES 
...
--
-- Table testopencart.oc_category_to_layout does not contain any data (it is empty)
...
--
-- Table testopencart.oc_coupon_history does not contain any data (it is empty)

-- 
-- Dumping data for table oc_coupon_product
--
-- Table testopencart.oc_coupon_product does not contain any data (it is empty)
...
--
-- Table testopencart.oc_customer does not contain any data (it is empty)
...
--
-- Table testopencart.oc_customer_ip does not contain any data (it is empty)

-- 
-- Dumping data for table oc_customer_ip_blacklist
--
-- Table testopencart.oc_customer_ip_blacklist does not contain any data (it is empty)

-- 
-- Dumping data for table oc_customer_online
--
-- Table testopencart.oc_customer_online does not contain any data (it is empty)

-- 
-- Dumping data for table oc_customer_reward
--
-- Table testopencart.oc_customer_reward does not contain any data (it is empty)

-- 
-- Dumping data for table oc_customer_transaction
--
-- Table testopencart.oc_customer_transaction does not contain any data (it is empty)

-- 
-- Dumping data for table oc_download
--
-- Table testopencart.oc_download does not contain any data (it is empty)

-- 
-- Dumping data for table oc_download_description
--
-- Table testopencart.oc_download_description does not contain any data (it is empty)
...
--
-- Table testopencart.oc_information_to_layout does not contain any data (it is empty)
...
--
-- Table testopencart.oc_order does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_download
--
-- Table testopencart.oc_order_download does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_fraud
--
-- Table testopencart.oc_order_fraud does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_history
--
-- Table testopencart.oc_order_history does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_misc
--
-- Table testopencart.oc_order_misc does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_option
--
-- Table testopencart.oc_order_option does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_product
--
-- Table testopencart.oc_order_product does not contain any data (it is empty)
...
--
-- Table testopencart.oc_order_total does not contain any data (it is empty)

-- 
-- Dumping data for table oc_order_voucher
--
-- Table testopencart.oc_order_voucher does not contain any data (it is empty)
...
--
-- Table testopencart.oc_product_tag does not contain any data (it is empty)
...
--
-- Table testopencart.oc_product_to_download does not contain any data (it is empty)

-- 
-- Dumping data for table oc_product_to_layout
--
-- Table testopencart.oc_product_to_layout does not contain any data (it is empty)
...
--
-- Table testopencart.oc_return does not contain any data (it is empty)
...
--
-- Table testopencart.oc_return_history does not contain any data (it is empty)
...
--
-- Table testopencart.oc_review does not contain any data (it is empty)
...
--
-- Table testopencart.oc_store does not contain any data (it is empty)
...
--
-- Table testopencart.oc_voucher does not contain any data (it is empty)

-- 
-- Dumping data for table oc_voucher_history
--
-- Table testopencart.oc_voucher_history does not contain any data (it is empty)
